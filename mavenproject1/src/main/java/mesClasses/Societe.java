...
/**
 * La classe société permet de définir une société. On y trouve les informations
 * suivantes: L'id de la société qui unique et non modifiable Le nom de la
 * société La liste de locaux qu'elle possède
 *
